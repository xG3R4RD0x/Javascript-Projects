(function () {
    ...
    */
    ...
    J("Promise", function (a) {
        ...
        b.prototype.B =
            function () {
                ...
                "function" === typeof e ? e = new e("unhandledrejection", {
                    ...
                    cancelable: !0
                }) : (e = H.document.createEvent("CustomEvent"), e.initCustomEvent("unhandledrejection", !1, !0, e));
                e.promise = this;
                e.reason = this.i;
                return k(e)
            };
        ...
        b.race = function (e) {
            return new b(function (g, k) {
                for (var l = M(e), q = l.next(); !q.done; q = l.next()) d(q.value).J(g, k)
            })
        };
        b.all = function (e) {
            var g = M(e),
            ...
            return k.done ? d([]) : new b(function (l, q) {
                ...
                var w = [],
                    t = 0;
                do w.push(void 0), t++, d(k.value).J(v(w.length - 1), q), k = g.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    var Aa, Ba = "undefined" !== typeof TextDecoder,
        Ca, Da = "undefined" !== typeof TextEncoder;
    ...
    function Ya(a) {
        ...
        a = a.h;
        var d;
        if (Ba)(d = Aa) || (d = Aa = new TextDecoder("utf-8", {
            fatal: !1
        })), d = d.decode(a.subarray(c, c + b));
        else {
            b = c + b;
            for (var f = [], h = null, e, g, k; c < b;) e = a[c++], 128 > e ? f.push(e) : 224 > e ? c >= b ? f.push(65533) : (g = a[c++], 194 > e || 128 !== (g & 192) ? (c--, f.push(65533)) : f.push((e & 31) << 6 | g & 63)) : 240 > e ? c >= b - 1 ? f.push(65533) : (g = a[c++], 128 !== (g & 192) || 224 === e && 160 > g || 237 === e && 160 <= g || 128 !== ((d = a[c++]) & 192) ? (c--, f.push(65533)) : f.push((e & 15) << 12 | (g & 63) << 6 | d & 63)) : 244 >= e ? c >= b - 2 ? f.push(65533) :
                (g = a[c++], 128 !== (g & 192) || 0 !== (e << 28) + (g - 144) >> 30 || 128 !== ((d = a[c++]) & 192) || 128 !== ((k = a[c++]) & 192) ? (c--, f.push(65533)) : (e = (e & 7) << 18 | (g & 63) << 12 | (d & 63) << 6 | k & 63, e -= 65536, f.push((e >> 10 & 1023) + 55296, (e & 1023) + 56320))) : f.push(65533), 8192 <= f.length && (h = za(h, f), f.length = 0);
            d = za(h, f)
        }
        return d
    };
    ...
    function T(a, b, c) {
        if (null != c) {
            ...
            var d = c;
            d = (c = 0 > d ? 1 : 0) ? -d : d;
            0 === d ? 0 < 1 / d ? P = Q = 0 : (Q = 0, P = 2147483648) : isNaN(d) ? (Q = 0, P = 2147483647) : 3.4028234663852886E38 < d ? (Q = 0, P = (c << 31 | 2139095040) >>> 0) : 1.1754943508222875E-38 > d ? (d = Math.round(d / Math.pow(2, -149)), Q = 0, P = (c << 31 | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2), d *= Math.pow(2, -b), d = Math.round(8388608 * d) & 8388607, Q = 0, P = (c << 31 | b + 127 << 23 | d) >>> 0);
            c = P;
            a.push(c >>> 0 & 255);
            a.push(c >>> 8 & 255);
            a.push(c >>> 16 & 255);
    ...
    function U(a, b, c) {
        ...
        if (c)
            for (b = 0; b < c.length; b++) a = c[b], a < this.l ? (a += this.j, (d = this.g[a]) ? eb(d) : this.g[a] = ib) : (jb(this), (d = this.h[a]) ? eb(d) : this.h[a] = ib)
    }
    ...
    function mb(a, b, c, d) {
        ...
        b = b ? b : new c;
        a = kb(a);
        void 0 != d ? (f.splice(d, 0, b), a.splice(d, 0, nb(b, !1))) : (f.push(b), a.push(nb(b, !1)))
    }
    ...
    function Gb(a, b) {
        ...
        if (void 0 === a.m) {
            ...
            c.attachShader(h, f);
            c.linkProgram(h);
            if (!c.getProgramParameter(h, c.LINK_STATUS)) throw Error("Could not compile WebGL program.\n\n" +
        ...
        return Y(a, function c() {
            ...
            return O(c, function (m) {
                switch (m.g) {
                    ...
                    case 2:
                        e = m.h;
                        if ("object" === typeof window) return Kb("createMediapipeSolutionsWasm", {
                            ...
                            return Y(f, function x() {
                                ...
                                return O(x, function (E) {
                                    z.g.graph &&
                                        z.g.graph.url ? E = N(E, Qb(z, z.g.graph.url), 0) : (E.g = 0, E = void 0);
                                    return E
                                })
                            })
    ...
    function Rb(a) {
        return Y(a, function c() {
            ...
            return O(c, function (w) {
                ...
                h = M(Object.keys(d.B));
                for (e = h.next(); !e.done; e = h.next()) g = e.value, d.i.overrideFile(g, d.B[g]);
                d.B = {};
                if (d.g.listeners)
                    for (k = M(d.g.listeners), l = k.next(); !l.done; l = k.next()) q = l.value, Sb(d, q);
                v = d.j;
                d.j = {};
                d.setOptions(v);
                w.g = 0
    ...
    D.setOptions = function (a, b) {
        ...
        if (b = b || this.g.options) {
            for (var d = [], f = [], h = {}, e = M(Object.keys(a)), g = e.next(); !g.done; h = {
                    K: h.K,
                    L: h.L
                }, g = e.next()) {
                var k = g.value;
                k in this.j && this.j[k] === a[k] || (this.j[k] = a[k], g = b[k], void 0 !== g && (g.onChange && (h.K = g.onChange, h.L = a[k], d.push(function (l) {
                    ...
                    calculatorName: "",
                    calculatorIndex: 0
                }), g.graphOptionXref), k), f.push(g))))
            }
            if (0 !== d.length || 0 !== f.length) this.o = !0, this.A = (void 0 === this.A ? [] : this.A).concat(f), this.u = (void 0 === this.u ? [] : this.u).concat(d)
        }
    };
                ...
                switch (v.g) {
                    ...
                    case 2:
                        if (d.A) {
                            ...
                            k = M(d.A);
                            for (l = k.next(); !l.done; l = k.next()) q = l.value, g.push_back(q);
                            d.i.changeOptions(g);
                            g.delete();
                            d.A = void 0
                        }
                    ...
                    case 3:
                        ...
                        for (k = g.next(); !k.done; k = g.next())
                            if (l = k.value, q = f.g.inputs[l]) {
                                        ...
                                        case "detections":
                                            ...
                                            for (x = 0; x < u.length; ++x) {
                                                ...
                                                if (null != C && null != C) {
                                                    ...
                                                    B >>>= 0;
                                                    C && (B = ~B >>>
                                                        0, n = (~n >>> 0) + 1, 4294967295 < n && (n = 0, B++, 4294967295 < B && (B = 0)));
                                                    P = n;
                                                    Q = B;
                                                    C = P;
                                                    for (n = Q; 0 < n || 127 < C;) p.push(C & 127 | 128), C = (C >>> 7 | n << 25) >>> 0, n >>>= 7;
                                                    p.push(C)
                                                }
                                                qb(r, A);
                                                I = ab(I);
                                                F.call(E, K, I);
                                                if (z.O)
                                                    for (E = 0; E < z.O.length; ++E) r = z.O[E], A = r.visibility ? !0 : !1, F = m.data, K = F.addNormalizedLandmark, I = x, r = Object.assign(Object.assign({}, r), {
                                                            visibility: A ? r.visibility : 0
                                                        }), A = new wb, W(A, 1, r.x), W(A, 2, r.y), W(A, 3, r.z), r.visibility && W(A, 4, r.visibility), p = r = new Za, T(p, 1, V(A, 1)), T(p, 2, V(A, 2)), T(p, 3, V(A, 3)), T(p, 4, V(A, 4)), T(p, 5, V(A, 5)),
                                                        qb(A, p), r = ab(r), K.call(F, I, r);
                                                if (z.M)
                                                    for (E = 0; E < z.M.length; ++E) {
                                                        ...
                                                        if (null != n && null != n)
                                                            if (S(p.g, 8), C = p.g, 0 <= n) S(C, n);
                                                                ...
                                                                for (B = 0; 9 > B; B++) C.push(n & 127 | 128), n >>= 7;
                                                                C.push(1)
                                                            } T(p, 2, V(A, 2));
                                                        C = V(A, 3);
                                                        null != C && (C = Ea(C), S(p.g, 26), S(p.g, C.length), $a(p, p.g.end()), $a(p, C));
                                                        C = V(A, 4);
                                                        null != C && (C = Ea(C), S(p.g, 34), S(p.g, C.length), $a(p, p.g.end()), $a(p,
                                                            C));
                                                        qb(A, p);
                                                        r = ab(r);
                                                        K.call(F, I, r)
                                ...
                                switch (q.type) {
                                    case "video":
                                        e.pushTexture2d(Object.assign(Object.assign({}, v), {
                                            stream: w,
                                            timestamp: h
                                        }));
                                        break;
            ...
            return O(f, function (F) {
                switch (F.g) {
                    case 1:
                        ...
                        e = 0;
                        g = M(Object.keys(c));
                        for (k = g.next(); !k.done; k = g.next()) l = k.value, q = c[l], "string" !== typeof q && "texture" === q.type && void 0 !== b[q.stream] && ++e;
                        1 < e && (v.G = !1);
                        w = M(Object.keys(c));
                        k = w.next();
                    case 2:
                        ...
                        t = k.value;
                        y = c[t];
                        if ("string" === typeof y) return z = h, E = t, N(F, Vb(v, t, b[y]), 14);
                        m = b[y.stream];
                        if ("detection_list" === y.type) {
                            if (m) {
                                ...
                                for (var I = m.getLandmarksList(), r = m.getClassificationsList(), A = [], C = 0; C < K.size(); ++C) {
                                    ...
                                    a: {
                                        var B = new Ab;
                                        for (p = new Ua(p); Va(p);) switch (p.i) {
                                            case 13:
                                                var n = R(p.g);
                                                W(B, 1, n);
                                                break;
                                            ...
                                            case 45:
                                                ...
                                                break;
                                            case 48:
                                                for (var G = p.g, L = 128, Ia = 0, Z = n = 0; 4 > Z && 128 <= L; Z++) L = G.h[G.g++], Ia |= (L & 127) << 7 * Z;
                                                128 <= L && (L = G.h[G.g++], Ia |= (L & 127) << 28, n |= (L & 127) >> 4);
                                                if (128 <= L)
                                                    for (Z = 0; 5 > Z && 128 <= L; Z++) L =
                                                        G.h[G.g++], n |= (L & 127) << 7 * Z + 3;
                                                if (128 > L) {
                                                    G = Ia >>> 0;
                                                    L = n >>> 0;
                                                    if (n = L & 2147483648) G = ~G + 1 >>> 0, L = ~L >>> 0, 0 == G && (L = L + 1 >>> 0);
                                                    G = 4294967296 * L + (G >>> 0);
                                                    n = n ? -G : G
                                                } else G.l = !0, n = void 0;
                                                W(B, 6, n);
                                    ...
                                    n = I.get(C);
                                    a: for (p = new yb, n = new Ua(n); Va(n);) switch (n.i) {
                                        case 10:
                                            G = Xa(n, new wb, xb);
                                            mb(p, G, wb, void 0);
                                            break;
                                    ...
                                    p = lb(p, wb).map(Db);
                                    G = r.get(C);
                                    a: for (n = new ub, G = new Ua(G); Va(G);) switch (G.i) {
                                        case 10:
                                            n.addClassification(Xa(G,
                                                new sb, tb));
                                            break;
                                        default:
                                            if (!rb(n, G)) break a
    ...
    function Sb(a, b) {
        for (var c = b.name || "$", d = [].concat(ea(b.wants)), f = new a.h.StringList, h = M(b.wants), e = h.next(); !e.done; e = h.next()) f.push_back(e.value);
                    ...
                    onChange: function (c) {
                        return Y(b, function f() {
                            ...
                            return O(f, function (l) {
                                if (1 == l.g) return h = Wb(c), e = "third_party/mediapipe/modules/selfie_segmentation/" + h, N(l, Qb(g.g, h), 2);
                                k = l.h;
